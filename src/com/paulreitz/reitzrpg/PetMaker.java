...
public class PetMaker {
	...
	public static void makePet(LivingEntity e, UUID toFollow,Player player) {
		try {
			...
			if (nms_entity instanceof EntityInsentient) {
				...
				target.a(1, new PathfinderGoalMeleeAttack( (EntityCreature) nms_entity  , Monster.class, 1.0D, true));
				target.a(2, new PathfinderGoalNearestAttackableTarget( (EntityCreature) nms_entity, Monster.class, 3, true));
				target.a(0, new PathfinderGoalNearestAttackableTarget( (EntityCreature) nms_entity, Zombie.class, 3, true));
				target.a(3, new PathfinderGoalNearestAttackableTarget( (EntityCreature) nms_entity, Skeleton.class, 0, true));
